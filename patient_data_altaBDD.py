...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(151, 22, 411, 161))
        self.layoutWidget.setObjectName(_fromUtf8("layoutWidget"))
        self.gridLayout = QtGui.QGridLayout(self.layoutWidget)
        self.gridLayout.setObjectName(_fromUtf8("gridLayout"))
        self.patient_tex = QtGui.QLineEdit(self.layoutWidget)
        ...
        self.age_patient_text_2 = QtGui.QLineEdit(self.layoutWidget)
        ...
        self.name_patient_text = QtGui.QLineEdit(self.layoutWidget)
